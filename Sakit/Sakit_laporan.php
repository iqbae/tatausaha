        ...
        <table align="center" width="86%" id="isit" class="grid" style="border:0.2mm solid #000;">
            <thead style="background:#e8ecee">
                <tr class="tr-title">
                    ...
                    <th class="center">Masa Istirahat</th>
                    <th class="center">Dari Tanggal</th>
                    <th class="center">Sampai Tanggal</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td align="center"><?php echo $data['masa_sakit']; ?></td>
                        <td align="center"><?php echo $data['dari_tanggal']; ?></td>
                        <td align="center"><?php echo $data['sampai_tanggal']; ?></td>
