  ...
  ?>
    ...
    <div id="isi">
      ...
      <div class="container" style="font-size: 11pt;">
        ...
        <p style="text-align: justify;">Berdasarkan hasil pemeriksaan yang telah kami laksanakan, pasien yang bersangkutan dalam keadaan sakit. Sehingga pasien tersebut memerlukan waktu beristirahat selama <b><?php echo $data['masa_sakit']; ?></b> hari. Dari tanggal <b><?php echo $data['dari_tanggal']; ?> sampai <?php echo $data['sampai_tanggal']; ?> </b><br><br>
          Demikian Surat Keterangan Sakit ini diberikan untuk diketahui dan dipergunakan sebagaimana mestinya.
        <p>
      </div>
    <?php
    $no++;
