...
?>
    ...
    <h2 align="center" >
        ...
        <div id="title">
            <h3><u>REKAP LAPORAN SURAT KETERANGAN SAKIT</u></h3>
        </div>
        <br>
        <div id="isi">
            ...
            <tr class="tr-title">
                ...
                <th class="center">Tempat Kematian</th>
                <th class="center">Sebab Kematian</th>
                <th class="center">Tanggal Meninggal</th>
      ...
      <?php
          ...
          ?>
            <tr>
              ...
              <td align="center"><?php echo $data['tempat_kematian']; ?></td>
              <td align="center"><?php echo $data['sebab_kematian']; ?></td>
              <td align="center"><?php echo tgl_eng_to_ind($data['tanggalmeninggal_dunia']); ?></td>
