...
$idsktm = $_GET['idsktm'];
$result = mysqli_query($con, "SELECT * FROM suratketerangantidakmampu WHERE idsktm=$idsktm");
...
if (isset($_POST['submit'])) {
  ...
  // update user data
  $result = mysqli_query($con, "UPDATE suratketerangantidakmampu SET nomor_surat='$nomor_surat',nik='$nik',nama='$nama',tempat_lahir='$tempat_lahir',tanggal_lahir='$tanggal_lahir',jenis_kelamin='$jenis_kelamin',status='$status',agama='$agama',kewarganegaraan='$kewarganegaraan',pekerjaan='$pekerjaan',alamat='$alamat',foto='$foto', tanggal_surat='$tanggal_surat' WHERE idsktm=$idsktm");
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Edit Data Surat Keterangan Tidak Mampu</h6>
  </div>
  <div class="card-body">
    <form method="POST" class="needs-validation" novalidate>
      ...
      <div class="form-group">
        <label for="foto">Upload Pengantar RT</label>
