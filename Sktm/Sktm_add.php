...
if (isset($_POST['submit'])) {
  ...
  $insert = mysqli_query($con, "INSERT INTO suratketerangantidakmampu(nomor_surat,nik,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,status,agama,kewarganegaraan,pekerjaan,alamat,foto,tanggal_surat) VALUES('$nomor_surat','$nik','$nama','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$status','$agama','$kewarganegaraan','$pekerjaan','$alamat','$direktori','$tanggal_surat')");
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?php echo $data['tempat_lahir'];?>" placeholder="Tempa Lahir" readonly>
          </div>
