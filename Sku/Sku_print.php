...
?>
    ...
    <h2 align="center" >
        ...
        ?>
        <div id="title">
            <h3><u>SURAT KETERANGAN BEBAS BUTA WARNA</u></h3><br>
        ...
        <div id="isi">
            ...
            <div class="container" style="font-size: 11pt;">
              <br>
                <p style="text-align: justify;">Telah diperiksa dengan teliti dan berpendapat bahwa yang namanya tersebut di atas </i></u><b> Bebas Buta Warna</i></u></b>.<br><br>
                Demikian Surat Keterangan Bebas Buta Warna ini dibuat untuk dipergunakan sebagaimana mestinya.</p>
            </div>
            <?php
          $no++;
            }
