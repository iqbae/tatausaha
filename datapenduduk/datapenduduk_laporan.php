...
?>
    ...
    <h2 align="center" >
        ...
        <div id="title">
            <h3><u>REKAP LAPORAN DATA PASIEN</u></h3>
        </div>
        <br>
        <div id="isi">
            ...
            <tr class="tr-title">
                ...
                <th class="left">Riwayat Penyakit</th>
      ...
      <?php
          ...
          ?>
            <tr>
              ...
              <td align="left"><?php echo $data['no_kartukeluarga']; ?> </td>
              <td align="center"><?php echo $data['tempat_lahir']; ?>, <?php echo tgl_eng_to_ind($data['tanggal_lahir']); ?></td>
