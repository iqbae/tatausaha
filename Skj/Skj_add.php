...
if (isset($_POST['submit'])) {
  ...
  $insert = mysqli_query($con, "INSERT INTO suratketeranganjanda(nomor_surat,nik,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,status,agama,kewarganegaraan,pekerjaan,alamat,keperluan,foto,tanggal_surat) VALUES('$nomor_surat','$nik','$nama','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$status','$agama','$kewarganegaraan','$pekerjaan','$alamat','$keperluan','$direktori','$tanggal_surat')");
